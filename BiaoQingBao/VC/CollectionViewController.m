...
-(void)firstLoadUserInterface
{
    ...
    [titles addObject:NSLocalizedString(@"Templet", @"制图模版")];
    [titles addObject:NSLocalizedString(@"Emoticon", @"表情")];
    [titles addObject:NSLocalizedString(@"Package", @"表情包")];
    [titles addObject:NSLocalizedString(@"WebAsset", @"网页抓图")];
    if (titles.count > 0) {
