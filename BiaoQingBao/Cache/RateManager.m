    ...
    if (!str) {
        ...
        if (dic) {
            ...
            if (subTitle.length == 0) {
                subTitle = NSLocalizedString(@"Five Stars Unlock All Modules", @"五星好评解锁所有功能，做最好用的免费表情软件。");
            }
            ...
            if (url.length > 0) {
                dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(60 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
                    ...
                    [alertView addButtonWithTitle:NSLocalizedString(@"Five Stars", @"去好评")
                    ...
                    [alertView addButtonWithTitle:NSLocalizedString(@"Next Time", @"下次")
